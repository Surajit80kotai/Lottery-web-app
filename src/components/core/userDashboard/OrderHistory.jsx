                        ...
                        <div className="col-md-4">
                            <div className="order_top_product">
                                <div className="product_image">
                                    <img src="/assets/img/laptop-png-images 1.png" alt="" />
                                </div>
                                <div className="product_container">
                                    <h4>Razer Blade Pro 17</h4>
                                    <p>Lightning speed - harness the power
                                        of a custom CPU, gpu, and
                                        SSD with integrated</p>
                                    ...
                                    <div className="num_ofticket">
                                        <h3>Number Of Ticket :<span> 236</span></h3>
                                        <h3>Date Of Result : <span> 28/12/22</span></h3>
                                    </div>
                                    <div className="mt-2">
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="right_side_product">
                                        <div className="right_product_content">
                                            <h2 className="prodcut_right_title">SONY PLAYSTATION 5</h2>
                                            <p className="right_para">Lightning speed - harness the power
                                                of a custom CPU, gpu, and
                                                SSD with integrated</p>
                                            <div className="num_ofticket">
                                                <h3>Number Of Ticket :<span> 236</span></h3>
                                            ...
                                            <button className="btn2">Buy Ticket</button>
                                        </div>
                                        <div className="right_product_img">
                                            <img src="/assets/img/9206435 1 (1).png" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="right_side_product">
                                        ...
                                        <div className="right_product_img">
                                            <img src="/assets/img/pngegg (2) 1.png" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
